...
- Only four hues exist outside neutrals: brand (deep teal-blue, the only interactive color), insight/amber (accumulation, "加精"/highlighted content — icons and fills only, never text), verified/jade (confirmed identity — small icon + text only, never a solid block), and brick/red (genuine risk only).
